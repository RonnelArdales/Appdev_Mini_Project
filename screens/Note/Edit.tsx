  ...
  return (
    <View style={styles.container } >
      <View style={styles.header}>
        ...
        {note.Title != Title || note.Description != Description  ? (<Ionicons name="checkmark-outline" size={29} color={"white"} style={{ alignSelf:"center",  marginTop:54, marginRight:18}} onPress={submit} />  ) : null}
        </View>
      </View>
